      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
          <div className="flex items-center gap-1 text-xs text-gray-400">
            <Clock size={12} />
            <span>Preverjeno: {timeAgo(product.last_checked, tick)}</span>
          </div>
      ...
      {expanded && (
        <div className="px-5 pb-5 bg-gray-50 border-t border-gray-100">
          <div className="grid grid-cols-2 gap-3 mt-3 text-sm">
            ...
            <div><span className="text-gray-500">Zadnjič na zalogi:</span><span className="ml-2 font-medium">{product.last_in_stock ? timeAgo(product.last_in_stock, tick) : "Nikoli"}</span></div>
          </div>
        </div>
      )}
    </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            <div className="p-3 bg-gray-50 rounded-xl">
              ...
              <div className="font-semibold mt-0.5">{status?.lastCheckTime ? timeAgo(status.lastCheckTime, tick) : 'Nikoli'}</div>
            </div>
            <div className="p-3 bg-gray-50 rounded-xl">
                  ...
                  <div key={w.id} className={cn("bg-white rounded-2xl border p-5 transition-all",
                    ...
                    <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
                      <div className="flex items-center gap-2 text-xs text-gray-400">
                        <Clock size={12} />
                        <span>Preverjeno: {timeAgo(w.last_checked, tick)}</span>
